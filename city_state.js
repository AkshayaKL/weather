...
city_states['Samoa'] = '|Apia||Aana|Aiga-i-le-Tai|Atua|Faasaleleaga|Gagaemauga|Gagaifomauga|Palauli|Satupa itea|Tuamasaga|Va "a-o-Fonoti|Vaisigano';
...
city_states['Georgia'] = '|T bilisi||Bat umi|Chiat ura|Gori|Guria|Imereti|Kakheti|Kutaisi|Kvemo Kartli|Mtskheta-Mtianeti|Poti|Racha-Lechkhumi/Kvemo Svaneti|Rust avi|Samegrelo/Zemo Svaneti|Samtskhe-Javakheti|Shida Kartli|Sokhumi|Tqibuli|Tsqaltubo|Zugdidi';
...
city_states['Yemen'] = '|Sanaa||Abyan|Adan|Al Bayda|Al Hudaydah|Al Jawf|Al Mahrah|Al Mahwit|Dhamar|Hadramawt|Hajjah|Ibb|Lahij|Marib|Sadah|Sana|Shabwah|Ta izz';
